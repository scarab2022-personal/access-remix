 ...
 */
\ir ../migrations/20221223151114_crud.sql
\set customer_id '733e54ae-c9dc-4b9a-94d0-764fbd1bd76e'
\set access_user_name 'Very Fancy User'
select create_access_user (:'access_user_name', 'This is fancy user', '8675', :'customer_id');

select delete_access_user (access_user_id, customer_id)
from access_user
where name = :'access_user_name'
